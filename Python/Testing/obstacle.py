...
class Obstacle:
    ...
    def __init__(self, map_dimensions, size, nb_pts):
        self.center = np.array([round(np.random.rand()*map_dimensions[0]),
                                round(np.random.rand()*map_dimensions[1])])
        ...
        self.points = np.array([self.center, (self.center[0], self.center[1]+size), (self.center[0]+size, self.center[1]), (self.center[0]+size, self.center[1]+size), self.center])
